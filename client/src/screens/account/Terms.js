  ...
  return (
    <ScreenWrapper>
      ...
      <ScrollView>
        ...
        <Text className=" mb-2">
          1. Odinstalowanie aplikacji z urządzenia mobilnego pasażera nie jest równoznaczne z usunięciem jego konta użytkownika. Aby trwale usunąć
          swoje konto, pasażer powinien skontaktować się z obsługą klienta.
        </Text>
        <Text className=" mb-2">
          2. Aplikacja może być wykorzystywana wyłącznie do celów prywatnych, w zakresie zamawiania usług przewozowych. Zabrania się korzystania z
          aplikacji w celach komercyjnych.
        </Text>
        <Text className=" mb-2">
          3. Korzystanie z aplikacji jest dozwolone jedynie w sposób zgodny z postanowieniami niniejszego regulaminu. Pasażer zobowiązuje się do
          przestrzegania wszystkich zasad i ograniczeń określonych przez Taxi Gow.
        </Text>
        <Text className=" mb-2">
          4. Usługodawca świadczy usługi drogą elektroniczną zgodnie z przepisami ustawy z dnia 18 lipca 2002 r. o świadczeniu usług drogą
